...
//        $this->middleware('json');
    ...
    public function excel_lista_cobranza_cuotas(ReporteDocumentosEmitidosInterface $repo, Request $request, SolicitudInterface $solicitud_repositorio)
    {
    ...
    public function guardar_venta(ReporteDocumentosEmitidosInterface $Repo, Request $request, CajaDiariaDetalleInterface $caja_diaria_detalle_repo, CajaDiariaInterface $caja_diaria_repositorio, ConsecutivosComprobantesInterface $repoCC, CustomerInterface $repo_cliente, CompaniaInterface $compania_repo)
    {
    ...
    public function get_notas_devolucion(ReporteDocumentosEmitidosInterface $Repo, Request $request)
    {
    ...
    public function get_notas_devolucion_find(ReporteDocumentosEmitidosInterface $Repo, Request $request)
    {
    ...
    public function get_venta_detalle_devolucion($id, ReporteDocumentosEmitidosInterface $repo, Request $request)
    {
        try {
            $arr = explode("*", $id);
    ...
    public function anularventa($id, ReporteDocumentosEmitidosInterface $repo, Request $request, CajaDiariaDetalleRepository $caja_repo)
    {
        try {
    ...
    public function get_venta_separacion(ReporteDocumentosEmitidosInterface $repo, Request $request) {
        $data = $request->all();
    ...
    public function get_venta_nota(ReporteDocumentosEmitidosInterface $repo, Request $request) {
        $data = $request->all();
    ...
    public function validar_ticket_pago_cuota(Request $request, ReporteDocumentosEmitidosInterface $repo, CajaDiariaDetalleInterface $repo_caja_diara_detalle) {
        $data = $request->all();
