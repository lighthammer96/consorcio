...
use App\Http\Recopro\ReasignacionVendedor\ReasignacionVendedorTrait;
...
use App\Http\Requests\ReasignacionVendedorRequest;
...
class ReasignacionVendedorController extends Controller
{
    use ReasignacionVendedorTrait;
...
//        $this->middleware('json');
    ...
    public function all(Request $request, ReasignacionVendedorInterface $repo)
    {
    ...
    public function list_ventas(Request $request, ReasignacionVendedorInterface $repo)
    {
        $s = $request->input('search', '');
    ...
    {
        $s = $request->input('search', '');
        $params = ['cCodConsecutivo', 'nConsecutivo', 'fecha_solicitud', 'tipo_solicitud', 'idconvenio', 'tipo_documento', 'numero_documento', 'cliente', 'moneda', 't_monto_total', 'pagado', 'saldo', 'facturado', 'estado', 'cuota', 'documento', 'serie'];
        // print_r($repo->search($s)); exit;
        return parseList($repo->search($s), $request, 'cCodConsecutivo', $params);
    }

    public function create(ReasignacionVendedorInterface $repo, ReasignacionVendedorRequest $request)
    {
        $data = $request->all();
    ...
    public function guardar_solicitud(ReasignacionVendedorInterface $repo, ReasignacionVendedorRequest $request, VentasInterface $ventas_repo)
    {
        $data = $request->all();
    ...
    public function update(ReasignacionVendedorInterface $repo, ReasignacionVendedorRequest $request)
    {
        $data = $request->all();
        // print_r($data);
    ...
    public function destroy(ReasignacionVendedorInterface $repo, Request $request)
    {
    ...
    public function getAll(ReasignacionVendedorInterface $repo)
    {
        return parseSelect($repo->all(), 'cCodConsecutivo', 'nombre_caja');
    }

    public function excel(ReasignacionVendedorInterface $repo)
    {
        return generateExcel($this->generateDataExcel($repo->all()), 'LISTA DE ReasignacionVendedor', 'ReasignacionVendedor');
    }

    public function data_form (ReasignacionVendedorInterface $Repo, Orden_servicioInterface $repo_orden, WarehouseInterface $WareRepo, VentasRepository $ventas_repositorio)
    {
    ...
    public function factor_credito(ReasignacionVendedorInterface $Repo, Request $request) {
    ...
    public function enviar_solicitud(ReasignacionVendedorInterface $Repo, Request $request) {
        $data = $request->all();
        $res = array("status" => "i");
        $data_update = array();
    ...
    public function find(ReasignacionVendedorInterface $Repo, Request $request, Orden_servicioInterface $repo_orden, VentasInterface $ventas_repo) {
        $data = $request->all();
    ...
    public function mostrar_aprobaciones(ReasignacionVendedorInterface $Repo, Request $request) {
        $data = $request->all();
    ...
    public function imprimir_solicitud($id, ReasignacionVendedorInterface $Repo, CajaDiariaDetalleInterface $repo_caja, CustomerInterface $cliente_repositorio, PersonaInterface $persona_repositorio) {
    ...
    public function imprimir_clausula_solicitud($id, ReasignacionVendedorInterface $Repo, CajaDiariaDetalleInterface $repo_caja, CustomerInterface $cliente_repositorio, PersonaInterface $persona_repositorio) {
    ...
    public function eliminar_solicitud(Request $request, ReasignacionVendedorInterface $solicitud_repositorio) {
        $data = $request->all();
    ...
    public function anular_solicitud(Request $request, ReasignacionVendedorInterface $solicitud_repositorio) {
        $data = $request->all();
    ...
    public function validar_serie(Request $request, ReasignacionVendedorInterface $repo) {
        $data = $request->all();
        $result = $repo->validar_serie($data["idserie"]);
        return response()->json($result);
    }

    public function copiar_solicitud(Request $request, ReasignacionVendedorInterface $repo) {
        $data = $request->all();
    ...
    public function obtener_separaciones(Request $request, ReasignacionVendedorInterface $repo) {
        $data = $request->all();
   ...
   public function obtener_series(Request $request, ReasignacionVendedorInterface $repo) {
    $data = $request->all();
