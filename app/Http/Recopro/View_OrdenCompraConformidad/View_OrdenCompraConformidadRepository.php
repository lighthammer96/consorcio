...
class View_OrdenCompraConformidadRepository implements View_OrdenCompraConformidadInterface
{
    ...
    {
        $mostrar = DB::select("select * from ERP_OrdenCompraConformidad as sl inner join ERP_Usuarios as us on 
    sl.nIdUsuario=us.id  where cCodConsecutivo='$cCod' AND nConsecutivo='$nr'");
        return $mostrar;
    }
