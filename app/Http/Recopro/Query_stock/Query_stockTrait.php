...
trait Query_stockTrait
{
    ...
    {
        $columns[] = ['Cod. Artículo','Articulo','Categoria','Unidad','Almacen','Localizacion','Lote','Serie','Tipo Compra Venta','Disponible','Remitido','Total','Transito','Costo_Promedio_Unitario','Costo_Total', 'Chasis', 'Motor', 'Color', 'Año', 'Ingreso'];
