...
class ReasignacionVendedorRepository implements ReasignacionVendedorInterface
{
    protected $model;
    private static $_ACTIVE = 'A';
    public function __construct(ReasignacionVendedor $model)
    {
        $this->model = $model;
    }
...
// >>>>>>> 4870a79d0dc412d8e5cb96175d98abd570e4358d
    ...
    public function mostrar_aprobaciones($cCodConsecutivo, $nConsecutivo) {
        ...
        FROM ERP_ReasignacionVendedorConformidad AS sc
    ...
    public function validar_serie($idserie) {
        ...
        INNER JOIN ERP_ReasignacionVendedorArticulo AS sa ON(sa.cCodConsecutivo=s.cCodConsecutivo AND sa.nConsecutivo=s.nConsecutivo)
    ...
    public function copiar_solicitud($cCodConsecutivo, $nConsecutivo) {
        ...
        SET NOCOUNT ON; EXEC	@return_value = [dbo].[VTA_CopiarReasignacionVendedorVenta]
    ...
    public function obtener_separaciones($cCodConsecutivo, $nConsecutivo) {
        ...
        FROM dbo.ERP_ReasignacionVendedorSeparacion AS ss 
