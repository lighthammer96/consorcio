...
");
    ...
    {
        $mostrar = DB::select("select os.id as idOrden,prv.razonsocial as razonSocialProveedor,mo.Descripcion as moneda, " .
            "os.cCodConsecutivo as cCodConsecutivo, os.nConsecutivo as nConsecutivo, os.IdMoneda as IdMoneda, " .
            "os.iEstado as est from ERP_OrdenCompra as os inner join ERP_Moneda as mo on os.idMoneda=mo.IdMoneda " .
            "inner join ERP_Proveedor as prv on (prv.id=os.idProveedor) where os.id in (select idOrden from " .
            "ERP_OrdenCompraArticulo where cantidadPendiente>0) and os.iEstado in(3,5)");
        return $mostrar;
    }
