...
(function () {
    ...
    function ReporteDocumentosEmitidosCtrl($scope, AlertFactory, RESTService) {
            ...
            recordsLoaded: function (event, data) {
                ...
                $('.anular-nota').click(function (e) {
                    ...
                    AlertFactory.confirm({
                        ...
                        RESTService.get('reporteDocumentosEmitidos/anularventa', code, function (response) {
                ...
                $('.emitir-nota').click(function (e) {
                    ...
                    $.post("reporteDocumentosEmitidos/get_caja_diaria", {},
                ...
                $('.reimprimir-comprobante').click(function (e) {
                    ...
                    $.post("reporteDocumentosEmitidos/validar_ticket_pago_cuota", { id: id },
                        function (data, textStatus, jqXHR) {
                            // console.log(data);
                            if(data.length <= 0) {
                                if (idtipodocumento == "12") {
                                    if(tipo_solicitud != "null") {
                                        ...
                                        window.open("reporteDocumentosEmitidos/imprimir_ticket/" + id);
                                    } else {
                                        window.open("reporteDocumentosEmitidos/imprimir_ticket_movimiento_caja/" + id);
                                    }
                                } else {
                                    window.open("reporteDocumentosEmitidos/imprimir_comprobante/" + id);
                                    
                                }
                            } else {
                              
                                window.open("reporteDocumentosEmitidos/imprimir_ticket_pago_cuota/" + id);
                            }
        ...
        function find_documento(id) {
            ...
            $.post("reporteDocumentosEmitidos/find_documento", { idventa: id },
                function (data, textStatus, jqXHR) {
                    ...
                    $.post("reporteDocumentosEmitidos/obtener_consecutivo_comprobante", { tipo_documento: '07' },
                        function (data, textStatus, jqXHR) {
        ...
        $scope.guardar_venta = function () {
            ...
            if (bval) {
                $.post("reporteDocumentosEmitidos/guardar_venta", $("#formulario-ventas").serialize(),
                    function (data, textStatus, jqXHR) {
